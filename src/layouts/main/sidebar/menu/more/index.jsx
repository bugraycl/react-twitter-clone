...
export default function More() {
    return (
        <Popover className="relative">
            <Popover.Button className="py-1 block group hover:border-none hover:shadow-none hover:outline-none">
                    <div className="p-3 rounded-full inline-flex items-center gap-5 group-hover:bg-[#eff3f41a] transition-colors">
                        <div className="w-[26.25px] h-[26.25px] relative">
                            <svg viewBox="0 0 24 24" aria-hidden="true" className="h-[1.641rem]">
            ...
            <Popover.Panel className="w-[318px] absolute bottom-0 left-0 bg-black shadow-box rounded-xl overflow-hidden">
                ...
                <Disclosure>
                    <Disclosure.Button className="h-[52px] flex items-center justify-between px-4 font-bold hover:bg-[#eff3f41a] w-full transition-colors">
                    ...
                    <Disclosure.Panel className="text-gray-500">
                        <Link to="/" className="flex items-center px-3 h-11 gap-3 text-[15px] font-medium text-white hover:bg-[#eff3f41a] w-full transition-colors">
                            <svg viewBox="0 0 24 24" width={18.75} height={18.75}>
